...
if (
  ...
  tabUrl.indexOf("wp-admin") <= 1 &&
  tabUrl.indexOf("wp-content") <= 1
) {
...
if (jQuery('a[href="https://www.findlaw.com/"]').text() == "FindLaw") {
  ...
  jQuery("body").append(
    '<a href="#" id="checkTypography" style="font-size: 20px;padding: 15px 20px;font-weight: bold;border-radius: 4px;background-color:#2ecc71;color:#fff;position:fixed;z-index: 999999;bottom: 10px;text-decoration: none;left: 10px;">T</a>'
  );
  ...
  function checkTypography() {
    ...
    if (headingLineHeightpx == "normal") {
      ...
      var headingLineHeightCalc = headingLineHeightpx
        .toString()
        .replace("px", "");
    ...
    jQuery("body").append(
      '<div class="typographyOverlay" style="position:fixed; display: none; width: 100%; height: 100%; background: rgba(0,0,0,0.6); left: 0; top: 0;"><div class="typographyPopup"  style="overflow:scroll;position:fixed; width: 600px; height: 90vh; top: 0; left: 50%; margin-left: -300px; z-index:9999999; background: #fff; padding: 30px 40px; border-radius:4px; margin-top: 5vh;"><a style="position:absolute; right: 20px; top: 20px;" href="#" id="toClose">Close</a><h1 style="margin-top: 0;">Site Width: ' +
        containerWidth +
        'px</h1><ul style="font-size: 20px; list-style-type:none; padding: 0; line-height: 1.5;"><li>Site title: <input style="display: block; width: 100%; padding: 10px; background: #f5f5f5; border: 1px solid #e4e4e4; border-radius: 4px; margin-bottom: 15px;" type="text" value="' +
        siteTitle +
        '" readonly></li><li>Tagline: <input style="display: block; width: 100%; padding: 10px; background: #f5f5f5; border: 1px solid #e4e4e4; border-radius: 4px; margin-bottom: 15px;" type="text" value="' +
        siteTagline +
        '" readonly></li></ul><h3>Heading</h3><ul style="font-size: 20px; list-style-type:none; padding: 0; line-height: 1.5;"><li>Font Family: ' +
        headingFontFamily +
        "</li><li>Font Size: " +
        headingFontSize +
        "</li><li>Font Weight: " +
        ...
        "</li><li>Line Height: " +
        headingLineHeight +
        "</li><li>Letter Spacing: " +
        headingLetterSpacing +
        "</li><li>Color: " +
        headingColor +
        '</li></ul><h3>Body</h3><ul style="font-size: 20px; list-style-type:none; padding: 0; line-height: 1.5;"><li>Font Family: ' +
        textFontFamily +
        "</li><li>Font Size: " +
        textFontSize +
        "</li><li>Font Weight: " +
...
function getServerID(url) {
  var siteUrl = url;
  // Example Server ID is : 123456 >> https://123456.findlaw2.flsitebuilder.com
  var slice1 = siteUrl.replace("https://", "");
