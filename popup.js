...
jQuery("#hideAdminBar").click(function () {
  chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
    chrome.tabs.executeScript(tabs[0].id, {
      code:
        "if ($('#wpadminbar').css('display') == 'none'){$('#wpadminbar').css('display','block');} else {$('#wpadminbar').css('display','none');}",
    });
  });
});
  ...
  chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
    chrome.tabs.executeScript(tabs[0].id, {
      code:
        ...
        "'" +
        "); + " +
        "$('.fl-main-content').not('.fl-main-content-title').append(" +
        "'" +
        typography +
        "'" +
        "); + " +
...
function renderButton(siteID, serverID, isFindlaw) {
  document
    .getElementById("checklandingbtn")
    .setAttribute(
      "href",
      "https://" +
        siteID +
        ...
        "." +
        isFindlaw +
        "/wp-admin/edit.php?post_type=landing-page"
    );
  document
    .getElementById("exportbtn")
    .setAttribute(
      "href",
      "https://flcssgit.smplwp.com/?site=" + siteID + "&export"
    );
  document
  ...
  document
    ...
    .setAttribute(
      ...
      "https://" +
        ...
        "." +
        isFindlaw +
        "/wp-admin/options-general.php?page=options-general-php-nap-management"
    );
  document
    .getElementById("ninjaFormBtn")
    .setAttribute(
      "href",
      "https://" +
        siteID +
        ...
        "." +
        isFindlaw +
        "/wp-admin/options-general.php?page=ninja-forms"
    );
  document
    .getElementById("flmigrationsbtn")
    .setAttribute(
      "href",
      "https://" +
        siteID +
        ...
        "." +
        isFindlaw +
        "/wp-admin/edit.php?post_type=fl_migration"
    );
  document
    .getElementById("themeBuilderBtn")
    .setAttribute(
      "href",
      "https://" +
        siteID +
...
function generateCSSLink(siteID, serverID) {
  ...
  var n = str.replace(/SITE_ID/g, siteID);
  var o = n.replace(/SERVER_ID/g, serverID);
